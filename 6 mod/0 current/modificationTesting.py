...
CNR_row = {0: {1: 0, 2: 1, 3: 2, 4: 3, 5: 4, 6: 5},
           7: {6: 0, 5: 1, 4: 2, 3: 3, 2: 4, 1: 5, 0: 6},
           56: {57:0, 58:1, 59:2, 60:3, 61:4, 62:5, 63:6},
           63: {62:0, 61:1, 60:2, 59:3, 58:4, 57:5, 56:6}} # corner:{index:distance from corner-1}
CNR_col = {0: {8: 0, 16: 1, 24: 2, 32: 3, 40: 4, 48: 5, 56: 6},
           7: {15: 0, 23: 1, 31: 2, 39: 3, 47: 4, 55: 5, 63: 0},
           56: {48:0, 40:1, 32:2, 24:3, 16:4, 8:5, 0:6},
           63: {55:0, 47:1, 39:2, 31:3, 23:4, 15:5, 7:6}}  # corner:{index:distance from corner-1}
# also note to self: try not to double count corners, but problem for later

CNR_diag = {0: {1: {2, 9, 16}, 2: {3, 10, 17, 24}, 3: {4, 11, 18, 25, 32},
                4: {5, 12, 19, 26, 33, 40}, 5: {6, 13, 20, 27, 34, 41, 48},
                6: {7, 14, 21, 28, 35, 42, 49, 56}},
            7: {1: {5, 14, 23}, 2: {4, 13, 22, 31}, 3: {3, 12, 21, 30, 39},
                4: {2, 11, 20, 29, 38, 47}, 5: {1, 10, 19, 28, 37, 46, 55},
                6: {0, 9, 18, 27, 36, 45, 54}},
            56: {1: {40, 49, 58}, 2: {32, 41, 50, 59}, 3: {24, 33, 42, 51, 60},
                 4: {16, 25, 34, 43, 52, 61}, 5: {8, 17, 26, 35, 44, 53, 62},
                 6: {0, 9, 18, 27, 36, 45, 54, 63}},
            63: {1: {47, 54, 61}, 2: {39, 46, 53, 60}, 3: {31, 38, 45, 52, 59},
                 4: {23, 30, 37, 40, 51, 58}, 5: {15, 22, 29, 36, 43, 50, 57},
                 6: {7, 14, 21, 28, 35, 42, 49, 56}}} # corner: {diagonal number: {indexes in diagonal}}
# note: finish these later and try not to double count corners
